...
def test_native_rag_ingest():
    ...
    request = ElasticSearchStoreRequest(
        ...
        docs=[
            Document(page_content='你好', metadata={'knowledge_title': '你好', 'knowledge_id': "1"}),
            Document(page_content='介绍一下你自己', metadata={'knowledge_title': '介绍一下你自己', 'knowledge_id': "2"}),
            Document(page_content='你是谁', metadata={'knowledge_title': '你是谁', 'knowledge_id': "3"}),
            Document(page_content='你会什么', metadata={'knowledge_title': '你会什么', 'knowledge_id': "4"}),
            Document(page_content='你能做什么', metadata={'knowledge_title': '你能做什么', 'knowledge_id': "5"}),
            Document(page_content='你能帮我做什么', metadata={'knowledge_title': '你能帮我做什么', 'knowledge_id': "6"}),
            Document(page_content='你能给我讲个笑话吗', metadata={'knowledge_title': '你能给我讲个笑话吗', 'knowledge_id': "7"}),
            Document(page_content='你能给我讲个故事吗', metadata={'knowledge_title': '你能给我讲个故事吗', 'knowledge_id': "8"}),
        ],
